...
-- these live here so you can tweak them in one place
ARCADE_GRAVITY   = 900   -- px/s²  (strong snappy gravity)
ARCADE_JUMP_VEL  = -340  -- px/s   (initial jump speed, negative = up)
ARCADE_JUMP_DUR  = 0.18  -- s      (hold-jump window)
ARCADE_WALK_SPD  = 2     -- px/frame (direct positional, not velocity)
