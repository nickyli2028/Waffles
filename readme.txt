...
- waffles_erics_copy.p8 is the primary cart
  - main_menu.p8 is technically the first one youre greated with but the former has all of the game stuff
  - 

To-Do List:
1. Main menu
2. Sprite transfer lua
    2.1. Music transfer lua
3. Buffer cart minigame
    3.1. global save data
